...
gcovr --gcov-executable gcov-13 . --json-summary --json ./test/coverage/coverage-summary.json --json-summary-pretty --cobertura ./test/coverage/coverage.cobertura.xml --cobertura-pretty --exclude "*/boost/*" --exclude "13/*" --exclude "/usr/include/*" --exclude "*/test/*"
